...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="nav-bg backdrop-blur-md border-b border-gray-800 sticky top-0 z-50">
                            ...
                            {user ? (
                                <div className="flex items-center gap-2 pl-2 border-l border-gray-800">
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-3 py-1.5 hover:bg-gray-800 text-gray-300 hover:text-white rounded-xl font-medium transition"
                                    >
                                        <div className="w-8 h-8 bg-green-900/30 border border-green-800/50 text-green-400 rounded-full flex items-center justify-center">
                                            <User size={16} />
                                        </div>
                                    </button>
                                </div>
                        ...
                        <div className="md:hidden flex items-center gap-2">
                            ...
                            {user && (
                                <button
                                    ...
                                    className="p-1.5 rounded-full bg-green-900/30 text-green-400 border border-green-800/50"
                                >
                                    <User size={22} />
                                </button>
                            )}
